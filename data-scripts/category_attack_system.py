...
VERIFIED_FOOD_IMAGES = {
    ...
    "stir_fry": {"general": "https://images.unsplash.com/photo-1512058564366-18510be2db19?w=1080&h=720&fit=crop&q=80"},
    "rice": {
    ...
    "pork": {"general": "https://images.unsplash.com/photo-1528607929212-2636ec44b3ae?w=1080&h=720&fit=crop&q=80"},
    "fish": {
    ...
    "cookies": {"general": "https://images.unsplash.com/photo-1481391243133-f96216dcb5d2?w=1080&h=720&fit=crop&q=80"},
    "ice_cream": {"general": "https://images.unsplash.com/photo-1501443762994-82bd5dace89a?w=1080&h=720&fit=crop&q=80"},
    # BREAKFAST
    "pancakes": {"general": "https://images.unsplash.com/photo-1506717847107-5e71b9242a28?w=1080&h=720&fit=crop&q=80"},
    "eggs": {"general": "https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=1080&h=720&fit=crop&q=80"},
    # SALADS & VEGETABLES
    "salad": {"general": "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=1080&h=720&fit=crop&q=80"},
    "soup": {"general": "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=1080&h=720&fit=crop&q=80"},
    # MEXICAN
    "tacos": {"general": "https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=1080&h=720&fit=crop&q=80"},
    "burrito": {"general": "https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=1080&h=720&fit=crop&q=80"},
    # GENERAL FALLBACK
    "general_food": {
...
def process_category(db, category, max_recipes=50):
    ...
    return {"processed": processed, "successful": successful, "failed": failed, "success_rate": success_rate}
...
def attack_all_categories(db, max_per_category=25):
    ...
    total_stats = {"categories_processed": 0, "total_recipes": 0, "total_successful": 0, "category_results": {}}
    ...
    for category, results in total_stats["category_results"].items():
        if results["processed"] > 0:
            print(
                f"   {category:<12} : {results['successful']:>3} / {results['processed']:>3} ({results['success_rate']:>5.1f}%)"
            )
