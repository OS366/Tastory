...
class TestServingSizeEstimation:
    ...
    def test_estimate_serving_size_baked_goods(self):
        ...
        test_cases = ["Chocolate Cake", "Apple Pie", "Banana Bread", "Sourdough Loaf"]
    ...
    def test_estimate_serving_size_salads(self):
        ...
        test_cases = ["Caesar Salad", "Green Salad", "Potato Side", "Rice Side Dish"]
    ...
    def test_estimate_serving_size_default(self):
        ...
        test_cases = ["Chicken Biryani", "Pasta Marinara", "Grilled Salmon", "Random Recipe Name"]
