...
module.exports = {
  ...
  safelist: [
    ...
    'fixed', 'top-0', 'right-0', 'top-4', 'right-4',
    'h-80', 'w-full', 'h-full', 'w-80',
    ...
    'bg-copper-500/80', // Added for search button
    ...
    'cursor-pointer', 'group', 'group-hover:text-copper-500', 'dark:group-hover:text-copper-400',
    'focus:outline-none', 'focus:ring-2', 'focus:ring-copper-400', 'focus:ring-opacity-50', 'focus:ring-opacity-75',
    ...
    'bg-copper-100', 'text-copper-700', 'hover:bg-copper-200',
    'dark:bg-copper-700', 'dark:text-copper-100', 'dark:hover:bg-copper-600',
    'bg-copper-500', 'hover:bg-copper-600',
    'dark:bg-copper-500', 'dark:hover:bg-copper-400',
    ...
    // Ensure all dark mode variants are included for gray and copper
    {
      pattern: /^(bg|text|border)-(gray|copper)-(50|100|200|300|400|500|600|700|800|900)$/,
      variants: ['dark'],
    },
